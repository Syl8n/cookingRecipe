...
class RecipeServiceTest {
    ...
    void success_createRecipe() {
        ...
        assertEquals(request.getMainImagePathSmall(),
                captorValue.getMainImagePathSmall());
        assertEquals(request.getMainImagePathBig(),
                captorValue.getMainImagePathBig());
        ...
        assertEquals(request.getManualImagePath(),
                captorValue.getManualImagePath());
    ...
    void success_readRecipe() {
        ...
        RecipeDto recipeDto = recipeService.readRecipe("id",
                httpRequest.getCookies(), httpResponse);

        //then
        assertEquals(recipe.getVisualId(), recipeDto.getVisualId());
        assertEquals(recipe.getTitle(), recipeDto.getTitle());
        assertEquals(recipe.getMainImagePathBig(),
                recipeDto.getMainImagePathBig());
        assertEquals(recipe.getMainImagePathSmall(),
                recipeDto.getMainImagePathSmall());
        ...
        assertEquals(recipe.getManualImagePath(),
                recipeDto.getManualImagePath());
    ...
    void success_readRecipe_viewsNotIncrease() {
        ...
        given(recipeRepository.findByVisualId(anyString()))
                .willReturn(Optional.of(recipe));
        //when
        Cookie[] cookies = new Cookie[]{new Cookie("recipeView",
                "[" + recipe.getVisualId() + "]")};
        RecipeDto recipeDto = recipeService.readRecipe("id", cookies,
                httpResponse);
    ...
    void fail_readRecipe_recipeNotFound() {
        ...
        //when
        CustomException exception = assertThrows(CustomException.class, () ->
                recipeService.readRecipe("id", httpRequest.getCookies(),
                        httpResponse)
        );
    ...
    void success_requestEditRecipe() {
        ...
        //when
        String recipeId = recipeService.checkAuthorityToEditRecipe("id",
                "email");
    ...
    void success_processEditRecipe() {
        ...
        assertEquals(req.getMainImagePathSmall(),
                captorValue.getMainImagePathSmall());
        assertEquals(req.getMainImagePathBig(),
                captorValue.getMainImagePathBig());
        ...
        assertEquals(req.getManualImagePath(),
                captorValue.getManualImagePath());
        assertEquals(member1.getEmail(), captorValue.getEmail());
    }
